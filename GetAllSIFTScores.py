...
class GetAllSIFTScores:
    ...
    def start_matching(self, photo_directory_path):
        ...
        image_loader = ImageLoader(self.cfg_file_path, self.yolo_weights_path, self.resized_width)
        ...
        yolo_text_file = open("all_SIFT_Scores_output_details.txt", "a+")
        ...
        csv_writer = csv.writer(open("all_SIFT_scores_output.csv", "w"))
